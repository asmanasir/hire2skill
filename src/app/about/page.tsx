...
export const metadata: Metadata = {
  ...
  description: 'SkillLink connects people with trusted local helpers across Norway. Learn about our mission, story, and values.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="text-white" style={{ background: 'linear-gradient(135deg,#1E3A8A,#38BDF8)' }}>
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto">
            SkillLink makes it easy to find skilled, verified helpers for any task — from cleaning and moving
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-4">
          <p>
            SkillLink started with a simple observation: finding reliable help for everyday tasks was
          ...
          <p>
            We built SkillLink to change that. Our platform makes it simple to post any task, browse
            verified local helpers, read honest reviews, and book with confidence — all in a few minutes.
          </p>
          <p>
            Today, SkillLink operates across Norway, connecting thousands of people with skilled helpers
